...
export const updateProfile = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.put("https://job-portal-mern-wcgv.vercel.app/api/v1/user/update/profile", data, {
...
export const updatePassword = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.put("https://job-portal-mern-wcgv.vercel.app/api/v1/user/update/password", data, {
      withCredentials: true,
